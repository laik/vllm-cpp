...
# Core library
# ============================================================
CORE_SRC  := $(SRC_DIR)/model.cpp
CORE_OBJ  := $(BUILD_DIR)/model.o
CORE_LIB  := $(BUILD_DIR)/libvllm-core.a

$(CORE_OBJ): $(CORE_SRC) $(SRC_DIR)/model.h $(SRC_DIR)/config.h | $(BUILD_DIR)
...
# CPU targets
# ============================================================
cpu: $(BUILD_DIR)/cpu_runner $(BUILD_DIR)/http_server $(BUILD_DIR)/interactive
...
$(BUILD_DIR)/http_server: $(SRC_DIR)/http_server.cpp $(CORE_LIB) | $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) -I$(SRC_DIR) $< $(CORE_LIB) -o $@

$(BUILD_DIR)/interactive: $(SRC_DIR)/interactive.cpp $(CORE_LIB) | $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) -I$(SRC_DIR) $< $(CORE_LIB) -o $@
...
info:
	...
	@echo "  make cpu      - build CPU-only targets"
	@echo "  make mlx      - build MLX backend + runner"
